...
@Component({
  selector: 'app-asesinos',
  templateUrl: './asesinos.page.html',
  styleUrls: ['./asesinos.page.scss'],
})
export class AsesinosPage implements OnInit {
  ...
  constructor(private figureService:FigurasService, private router:Router, private modalCtrl: ModalController) {
    ...
    this.figureService.getAllUnits("asesino").then(res => {
  ...
  async openModal(id: string){
    ...
    await this.figureService.getById("asesino",id).then(res => {
