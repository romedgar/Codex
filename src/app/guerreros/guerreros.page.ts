...
@Component({
  ...
  templateUrl: './guerreros.page.html',
  styleUrls: ['./guerreros.page.scss'],
})
export class GuerrerosPage implements OnInit {
  ...
  constructor(private figureService:FigurasService, private router:Router, private modalCtrl: ModalController) {
    ...
    this.figureService.getAllUnits("guerrero").then(res => {
  ...
  async openModal(id: string){
    ...
    await this.figureService.getById("guerrero",id).then(res => {
